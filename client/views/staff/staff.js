...
Template.staff.helpers({
  settings: function () {
    return {
      ...
      [
        ...
        { key: 'employmentDate', label: 'Принят', fn: function (value, object) { return value.toLocaleDateString(); } },
        { key: 'dismissalDate', label: 'Уволен', fn: function (value, object) { if (value > '') { return value.toLocaleDateString(); } else { return 'работает' } } },
  ...
  datetimepickerOptions: function() { return { format: 'HH:mm', pickDate: false, useCurrent: false } },
});
