...
var timecardSpecCodesSource = [
    ...
    { value:"spec01", text:"Я (Продолжительность работы в дневное время)"},
    { value:"spec02", text:"Н (Продолжительность работы в ночное время)"},
    { value:"spec03", text:"РП (Продолжительность работы в выходные и нерабочие праздничные дни)"},
    { value:"spec04", text:"С (Продолжительность сверхурочной работы)"},
    { value:"spec05", text:"ВМ (Продолжительность работы вахтовым методом)"},
    { value:"spec06_8", text:"К (Служебная командировка)"},
    { value:"spec07", text:"ПК (Повышение квалификации с отрывом от работы)"},
    { value:"spec08", text:"ПМ (Повышение квалификации с отрывом от работы в другой местности)"},
    { value:"spec09", text:"ОТ (Ежегодный основной оплачиваемый отпуск)"},
    { value:"spec10", text:"ОД (Ежегодный дополнительный оплачиваемый отпуск)"},
    { value:"spec11", text:"У (Доп. отп. в связи с обуч. с сохр. сред. зараб. работ., совм. работу с обуч.)"},
    { value:"spec12", text:"УВ (Сокр. прод. раб. врем. для обуч. без отрыва от произв. с част. сохр. зараб. платы)"},
    { value:"spec13", text:"УД (Дополнительный отпуск в связи с обучением без сохранения заработной платы)"},
    { value:"spec14", text:"Р (Отпуск по беременности и родам (отпуск в связи с усыновлением новорожденного ребенка))"},
    { value:"spec15", text:"ОЖ (Отпуск по уходу за ребенком до достижения им возраста трех лет)"},
    { value:"spec16", text:"ДО (Отпуск без сохр. зараб. платы, предостав. работнику по разрешению работодателя)"},
    { value:"spec17", text:"ОЗ (Отпуск без сохранения заработной платы в случаях, предусмотренных законодательством)"},
    { value:"spec18", text:"ДБ (Ежегодный дополнительный отпуск без сохранения заработной платы)"},
    { value:"spec19", text:"Б (Врем. нетрудоспособ. (кроме случаев, предусм. кодом \"Т\") с назнач. пособия согл. законодат.)"},
    { value:"spec20", text:"Т (Врем. нетрудоспособ. без назн. пособия в случаях, предусм. законодат. )"},
    { value:"spec21", text:"ЛЧ (Сокр. прод. рабоч. врем. против норм. продолжит. рабоч. дня в случаях, предусм. законодат.)"},
    { value:"spec22", text:"ПВ (Вр. вын. прог. в случ. призн. ув., пер. на др. раб. или отстр. от раб. незак. с восст. на преж. раб.)"},
    { value:"spec23", text:"Г (Невых. на время исп. госуд. или обществ. обяз. согл. законодат.)"},
    { value:"spec24", text:"ПР (Прогулы (отсут. на раб. месте без уваж. причин в течение врем., устан. законодат.))"},
    { value:"spec25", text:"НС (Прод. раб. в реж. неполн. раб. врем. по иниц. работодат. в случ., предусм. законодат.)"},
    { value:"spec26", text:"В (Выходные дни (еженед. отпуск) и нерабоч. праздн. дни)"},
    { value:"spec27", text:"ОВ (Дополнительные выходные дни (оплачиваемые))"},
    { value:"spec28", text:"НВ (Дополнительные выходные дни (без сохранения заработной платы))"},
    { value:"spec29", text:"ЗБ (Забастовка (при условиях и в порядке, предусмотренных законом))"},
    { value:"spec30", text:"НН (Неявки по невыясненным причинам (до выяснения обстоятельств))"},
    { value:"spec31", text:"РП (Время простоя по вине работодателя)"},
    { value:"spec32", text:"НП (Время простоя по причинам, не зависящим от работодателя и работника)"},
    { value:"spec33", text:"ВП (Время простоя по вине работника)"},
    { value:"spec34", text:"НО (Отстранение от работы (недопущение к работе) с оплатой (пособием) в соответствии с законодательством )"},
    { value:"spec35", text:"НБ (Отстранение от работы (недопущение к работе) по причинам, предусмотренным законодательством, без начисления заработной платы)"},
    { value:"spec36", text:"НЗ (Время приостановки работы в случае задержки выплаты заработной платы)"},
];
