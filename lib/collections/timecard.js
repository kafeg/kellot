    ...
    monthHalf1: {
        ...
        autoValue: function (newDoc) {
            if (this.isUpdate) {
                ...
                //console.log('monthHalf1 0', newObjSpecVal, secondKeyNum);

                var newObjType = fSWT(newObjSpecVal);
                //console.log('monthHalf1 5', newObjVal, newObjSpecVal, newObjSet, newObjType);
                if (secondKeyNum > 15) {
                    newObjType = '0';
                }

                //console.log('monthHalf1 1');
                var allTime = 0;
                if (newObjType == 'work') {
                    allTime += timestrToSec(newObjVal);
                }

                //console.log('monthHalf1 2');
                for (var i = 1; i <= 15; i++) {
                    //console.log(doc['d' + i], timestrToSec(doc['d' + i]));
                    if (doc['d' + i] != '0') {
                        if (i != secondKeyNum) {
                            //console.log('dt', doc['dt' + i]);
                            var objType = fSWT(doc['dt' + i]);
                            if (objType == 'work') {
                ...
                //console.log('monthHalf1 3', res, allTime);
