...
Router.map(function () {
    ...
    this.route('activateInviteToCompany', {
        ...
        waitOn: function () {
            ...
            //return Meteor.subscribe("inviteToken", Router.current().params.activationToken, {
            //    onReady: function () {
            //        Meteor.subscribe('companyToken', Router.current().params.activationToken, {
            //            onReady: function () {
            //                Meteor.subscribe('userToken', Router.current().params.activationToken);
            //            }
            //        });
            //    }
            //});
...
Router.onBeforeAction(function (pause) {
    ...
    if (Meteor.userId() == null) {
        //if (Router.current().params.activationToken != undefined) {
        //    Router.go('inviteInstruction');
        //}
        if (pause.url != '/index'
            && pause.url != '/'
            && pause.url != '/reviews'
    ...
    if (Meteor.isClient && Meteor.userId() != null) {
        ...
        //console.log(pause);
        //check if user first login by email invite code
